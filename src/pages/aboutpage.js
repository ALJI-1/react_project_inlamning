            ...
            <div id="carouselExampleCaptions" className="carousel slide" style={{ maxWidth: '600px', margin: '0 auto' }}>
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        ...
                        <div className="carousel-caption d-none d-md-block" style={{ textShadow: '4px 4px 8px rgba(0, 0, 0, 1)' }}>
                            <h5>Optimus Codius</h5>
                            <p>"Code isn't just syntax – it's the will to change the world, one line at a time."</p>
                        </div>
                    </div>
                    <div className="carousel-item">
                        ...
                        <div className="carousel-caption d-none d-md-block" style={{ textShadow: '4px 4px 8px rgba(0, 0, 0, 1)' }}>
                            <h5>Harry Syntax</h5>
                            <p>"It’s not the language you code in that defines you, but the choices you make when the system crashes."</p>
                        </div>
                    </div>
                    <div className="carousel-item">
                        ...
                        <div className="carousel-caption d-none d-md-block" style={{ textShadow: '4px 4px 8px rgba(0, 0, 0, 1)' }}>
                            ...
                            <p>"A single line of code may seem small, yet in the right hands, it can hold back the darkness of an entire system crash."</p>
                        </div>
                    </div>
                </div>
